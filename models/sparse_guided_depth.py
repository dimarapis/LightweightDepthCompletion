...
from models.guide_ddrnet import DualResNet_Backbone, DualResNet_Backbone_Modified
...
class DecnetNLSPN_sharedDecoder(nn.Module):
    def __init__(self, args, 
            pretrained=False,
            up_features=[64, 32, 16], 
            inner_features=[64, 32, 16]):
        super(DecnetNLSPN_sharedDecoder, self).__init__()
    ...
    def forward(self, rgb, sparse):
        ...
        id_fd1 = self.id_dec1(self._concat(xy_3, fe2))
        ...
        # Guidance Decoding
        gd_fd1 = self.gd_dec1(self._concat(xy_3, fe2))
        ...
        # Confidence Decoding
        cf_fd1 = self.cf_dec1(self._concat(xy_3, fe2))
