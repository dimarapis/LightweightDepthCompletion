...
def all_args_parser():
    ...
    parser.add_argument('--networkmodel',
                        type=str,
                        default="DecnetNLSPN",
                        choices=["nlspn","DecnetModuleSmall","DecnetLateBase","DecnetEarlyBase","DecnetNLSPNSmall","DecnetNLSPN_decoshared","GuideDepth", "SparseGuidedDepth", "SparseAndRGBGuidedDepth", "AuxGuideDepth", "ENET2021","AuxSparseGuidedDepth", "DecnetModule", "DecnetNLSPN"],
                        help='choose a model'
                        )
